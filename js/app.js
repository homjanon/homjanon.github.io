...
const App = (function() {
    ...
    function showConfigModal() {
        ...
        document.getElementById('config-use-akshare').checked = config.useAkShare === true;
    ...
    function saveConfig() {
        ...
        const useAkShare = document.getElementById('config-use-akshare').checked;
        
        const existing = StorageManager.getConfig();
        const config = { ...existing, finnhubKey, biyingKey, corsProxy, demoMode, useTencent, useAkShare };
